...
nucleon_properties = {
    ...
    "V": {"II": 7,
          ...
          "abundance": 1},
    "Cr": {"II": np.array((3, 0)),
           "gyromag_ratio": np.array((15.119, 0)),
           "abundance": np.array((0.0955, 0.9045)),
           "charge": +3,
           },
    "Ni": {"II": np.array((3, 0)),
           "gyromag_ratio": np.array((23.906, 0)),
           "abundance": np.array((0.0119, 0.9881)),
           "charge": +2,
    },
    "Cu": {"II": 3,
           "gyromag_ratio": 73.431,
           'abundance': 1,
           "charge": +2,
           "Q": -0.2,  # average both isotopes
           "anti_shielding": 0},
    "Y": {"II": 1,
